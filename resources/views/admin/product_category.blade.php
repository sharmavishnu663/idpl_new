...
@section('content')
            ...
            <div class="position-relative container-fluid px-0">
                <div class="row align-items-center position-relative">
                    <div class="col-md-8 mb-4 mb-md-0">
                        <h3 class="mb-2">Product Category</h3>
                    ...
                    <div class="card-tools">
                        <button class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle"
                            style="float: right">Add Category</button>
                                                ...
                                                @foreach ($product_categories as $category)
                                                    <tr>
                                                        ...
                                                        <td> <a class="js-edit-logo" data-bs-toggle="modal"
                                                                ...
                                                                title="edit category" data-id="{{ @$category->id }}"
                                                                data-name="{{ @$category->name }}"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a class="delete-material"
                                                                href="{{ route('delete.category.product', @$category->id) }}"
                                                                data-id="{{ @$office->id }}" title="delete category"
            ...
            <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.add.category.product') }}" method="post"
            ...
            <div class="modal fade" id="editModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.edit.category.product') }}" method="post"
                            enctype="multipart/form-data">
    ...
    <script>
        $(".js-edit-logo").on('click', function(e) {
            ...
            $("#editModal .modal-dialog #category_id").val(id);
